Feature: Manage stores
  ...
  Scenario: View store details
    When I go to the Convention Center store page
    Then I should see "Address: "
    And I should see "1000 Fort Duquesne Blvd"
    And I should see "Pittsburgh, PA 15222"
    And I should see "Current Employees"
    And I should not see "Brunk, Stafford"
    And I should not see "Crawford, Cindy"
    And I should not see "Rubinstein, Ari"
    And I should see "Hersh, Jon"
    And I should see "Schell, Evan"
    And I should see "Holt, Peter"
  ...
  Scenario: The store name is a link to details
    ...
    And I should see "Current Employees"
    And I should see "Correa, Jake"
    And I should see "Brunk, Stafford"
    And I should see "Rubinstein, Ari"
    And I should not see "Wilson, Allie"
  ...
  Scenario: Creating a new store fails without unique name
    When I go to the new store page
    And I fill in "store_name" with "CMU"
