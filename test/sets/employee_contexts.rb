module Contexts
  module EmployeeContexts
    ...
    def create_additional_employees
      ...
      @liu = FactoryGirl.create(:employee, first_name: "Angela", last_name: "Liu", date_of_birth: 245.months.ago.to_date, role: "manager")
      @wilson = FactoryGirl.create(:employee, first_name: "Allie", last_name: "Wilson", date_of_birth: 234.months.ago.to_date, role: "manager")
      @correa = FactoryGirl.create(:employee, first_name: "Jake", last_name: "Correa", date_of_birth: 240.months.ago.to_date, role: "manager")
      @hersh = FactoryGirl.create(:employee, first_name: "Jon", last_name: "Hersh", ssn: "234567890", phone: "4122683259", date_of_birth: 27.years.ago.to_date)
      @rubinstein = FactoryGirl.create(:employee, first_name: "Ari", last_name: "Rubinstein", ssn: "234567891", phone: "4122683258", date_of_birth: 25.years.ago.to_date)
      @brunk = FactoryGirl.create(:employee, first_name: "Stafford", last_name: "Brunk", ssn: "234567892", phone: "4122683257", date_of_birth: 23.years.ago.to_date)
      ...
      @mark = FactoryGirl.create(:employee, first_name: "Mark", last_name: "Heimann", ssn: "084-21-3091", date_of_birth: "1993-01-25", phone: "724-713-3333", role: "admin")
    end
